            ...
            <div className="p-3 sm:p-4">
                <div className="bg-white border border-blue-200 max-w-4xl mx-auto p-3 sm:p-5 rounded-2xl flex flex-col sm:flex-row gap-4 sm:gap-0 sm:justify-between sm:items-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
                        <div className="border-gray-200 border-2 rounded-xl p-2 w-full sm:w-56">
                            <input type="text" placeholder="search..." onChange={(e) => setLocation(e.target.value)} value={location} className="w-full px-3 focus:outline-0 text-sm" />
                        </div>
                        <button onClick={getRealTimeWeather} className="bg-blue-600 text-white p-2 px-4 rounded-xl hover:bg-blue-800 w-full sm:w-auto">
                            Search
                        </button>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <div className="flex flex-col sm:flex-row items-center gap-3">
                            <div className="text-center">
                                <img src={realTimeResponse?.current.condition.icon} alt={realTimeResponse?.current.condition.text} className="mx-auto w-16 sm:w-auto" />
                        ...
                        <p className="text-sm sm:text-xl text-blue-800 text-center">
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-12 sm:mt-20">
                    ...
                    <div className="bg-blue-50 p-3 py-8 rounded-xl border border-blue-300 flex gap-3 justify-center items-center">
                        ...
                        <div className="text-center">
                            <h3 className="text-blue-500">Wind Speed & Direction</h3>
                            <p className="text-blue-900 text-lg sm:text-xl font-semibold py-2">
                                {realTimeResponse?.current.wind_kph} <span className='text-sm'>km/h</span> {realTimeResponse?.current.wind_dir}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-blue-50 p-3 py-8 rounded-xl border border-blue-300 flex gap-3 justify-center items-center sm:row-span-2">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-blue-900 text-lg sm:text-xl font-semibold py-2">
                                {realTimeResponse?.current.pressure_mb} mb
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-blue-50 p-3 py-8 rounded-xl border border-blue-300 flex gap-3 justify-center items-center">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-blue-900 text-lg sm:text-xl font-semibold py-2">
                                {realTimeResponse?.current.precip_mm} mm
                            </p>
                        </div>
                    </div>

                    <div onClick={() => navigate("/forecast")} className="bg-blue-600 text-white font-semibold p-3 col-span-1 sm:col-span-2 md:col-span-3 flex gap-2 justify-center items-center rounded-xl hover:bg-blue-700 cursor-pointer">
                        Forecast Page
                        <ArrowRight />
                    </div>
                </div>
